      ...
      this.dispatched = [
        {
          ...
          bids: [
            {providerId: 'id-reference-1', name: 'A Speed', amount: 340.00, rating: 'A', status: 'Pending'},
            {providerId: 'id-reference-2', name: 'B Speed', amount: 320.00, rating: 'B', status: 'Pending'}
          ]
        },
        {
          ...
          bids: [
            ...
            {providerId: 'id-reference-1', name: 'A Speed', amount: 340.00, rating: 'A', status: 'Accepted'},
            {providerId: 'id-reference-3', name: 'C Speed', amount: 320.00, rating: 'B', status: 'Declined'}
          ]
        }
      ];
  }
