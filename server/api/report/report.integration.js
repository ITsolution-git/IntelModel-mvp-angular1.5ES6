...
describe('Report API:', function() {
    ...
    it('should respond with the updated report on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          expect(report.name).to.equal('Updated Report');
          expect(report.info).to.equal('This is the updated report!!!');
  ...
  describe('PATCH /api/reports/:id', function() {
    ...
    it('should respond with the patched report', function() {
      expect(patchedReport.name).to.equal('Patched Report');
      expect(patchedReport.info).to.equal('This is the patched report!!!');
    });
  });
